...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Ludirium
else
  DOCKER_EXEC echo \> \$HOME/.ludirium
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/ludirium/ludirium/pull/18288#discussion_r433189350 for
  # details.
