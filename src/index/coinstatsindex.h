// Copyright (c) 2020-2021 The Ludirium Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef LUDIRIUM_INDEX_COINSTATSINDEX_H
#define LUDIRIUM_INDEX_COINSTATSINDEX_H
...
#endif // LUDIRIUM_INDEX_COINSTATSINDEX_H
