...
#ifndef LUDIRIUM_RPC_PROTOCOL_H
#define LUDIRIUM_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in ludiriumd
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Ludirium is not connected
