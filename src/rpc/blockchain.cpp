        ...
        },
        {
            ...
            RPCResult{"Otherwise", RPCResult::Type::OBJ, "", "", {
                ...
                {RPCResult::Type::OBJ, "scriptPubKey", "", {
                    ...
                    {RPCResult::Type::STR, "address", /* optional */ true, "ludirium address (only if a well-defined address exists)"},
                    {RPCResult::Type::ARR, "addresses", /* optional */ true, "(DEPRECATED, returned only if config option -deprecatedrpc=addresses is passed) Array of ludirium addresses",
                        {{RPCResult::Type::STR, "address", "ludirium address"}}},
                }},
...
static RPCHelpMan getblockstats()
{
    return RPCHelpMan{"getblockstats",
                "\nCompute per block statistics for a given window. All amounts are in kenshins.\n"
            ...
            RPCResult::Type::OBJ, "", "",
            {
                ...
                {RPCResult::Type::NUM, "avgfeerate", "Average feerate (in kenshins per virtual byte)"},
                ...
                {RPCResult::Type::ARR_FIXED, "feerate_percentiles", "Feerates at the 10th, 25th, 50th, 75th, and 90th percentile weight unit (in kenshins per virtual byte)",
                {
                ...
                {RPCResult::Type::NUM, "maxfeerate", "Maximum feerate (in kenshins per virtual byte)"},
                ...
                {RPCResult::Type::NUM, "minfeerate", "Minimum feerate (in kenshins per virtual byte)"},
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    for (size_t i = 0; i < block.vtx.size(); ++i) {
        ...
        if (loop_inputs) {
            ...
            // New feerate uses kenshins per virtual byte instead of per serialized byte
    ...
    ret_all.pushKV("avgfeerate", total_weight ? (totalfee * WITNESS_SCALE_FACTOR) / total_weight : 0); // Unit: ken/vbyte
...
UniValue CreateUTXOSnapshot(NodeContext& node, CChainState& chainstate, CAutoFile& afile)
{
...

    {
        ...
        //
        // See discussion here:
        //   https://github.com/ludirium/ludirium/pull/15606#discussion_r274479369
        //
        LOCK(::cs_main);
