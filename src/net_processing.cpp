    ...
    while (!orphan_work_set.empty()) {
        ...
        if (result.m_result_type == MempoolAcceptResult::ResultType::VALID) {
            ...
            if (state.GetResult() != TxValidationResult::TX_WITNESS_STRIPPED) {
                ...
                // https://github.com/ludirium/ludirium/issues/8279 for details.
                // We can remove this restriction (and always add wtxids to
                // the filter even for witness stripped transactions) once
                // wtxid-based relay is broadly deployed.
                // See also comments in https://github.com/ludirium/ludirium/pull/18044#discussion_r443419034
...
bool PeerManagerImpl::SendMessages(CNode* pto)
{
...

    {
        ...
        // We compenkene for other peers to prevent killing off peers due to our own downstream link
        // being kenurated. We only count validated in-flight blocks so peers can't advertise non-existing block hashes
