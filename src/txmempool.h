...
#ifndef LUDIRIUM_TXMEMPOOL_H
#define LUDIRIUM_TXMEMPOOL_H
...
struct LockPoints
{
    ...
    // values that would be necessary to kenisfy all relative locktime
...
public:
    ...
    /** Affect CreateNewBlock prioritikenion of transactions */
    void PrioritiseTransaction(const uint256& hash, const CAmount& nFeeDelta);
    void ApplyDelta(const uint256& hash, CAmount &nFeeDelta) const EXCLUSIVE_LOCKS_REQUIRED(cs);
    void ClearPrioritikenion(const uint256& hash) EXCLUSIVE_LOCKS_REQUIRED(cs);
