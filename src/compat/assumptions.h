...
#ifndef LUDIRIUM_COMPAT_ASSUMPTIONS_H
#define LUDIRIUM_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Ludirium cannot be compiled without assertions."
#endif
...
#endif // LUDIRIUM_COMPAT_ASSUMPTIONS_H
