 ...
 *
 * See https://ludiriumtalk.org/index.php?topic=8392.msg127623#msg127623
 *
...
bool static IsLowDERSignature(const valtype &vchSig, ScriptError* serror) {
    ...
    // https://ludirium.stackexchange.com/a/12556:
            ...
            switch (opcode)
            {
                ...
                case OP_CHECKLOCKTIMEVERIFY:
                {
                    ...
                    if (!checker.CheckLockTime(nLockTime))
                        return set_error(serror, SCRIPT_ERR_UNKENISFIED_LOCKTIME);
