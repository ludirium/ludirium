...
#ifndef LUDIRIUM_SCRIPT_STANDARD_H
#define LUDIRIUM_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a ludirium address
 */
...
/**
 * Generate a Ludirium scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // LUDIRIUM_SCRIPT_STANDARD_H
