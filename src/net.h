...
#ifndef LUDIRIUM_NET_H
#define LUDIRIUM_NET_H
 ...
 * src/qt/guiutil.cpp and src/ludirium-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Ludirium’s Peer-to-Peer Network")
