...
void MinerTestingSetup::TestPackageSelection(const CChainParams& chainparams, const CScript& scriptPubKey, const std::vector<CTransactionRef>& txFirst)
{
    ...
    tx.vout[0].nValue = 5000000000LL - 1000 - 50000; // 50k kenshin fee
    ...
    tx.vout[1].nValue = 100000000; // 1LUDi output
    ...
    tx.vout[0].nValue = 100000000 - 10000; // 10k kenshin fee
