...
#ifndef LUDIRIUM_TEST_SCRIPTNUM10_H
#define LUDIRIUM_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Ludirium Core 0.10.0, for cross-comparison.
 */
public:
