...
#ifndef LUDIRIUM_ARITH_UINT256_H
#define LUDIRIUM_ARITH_UINT256_H
...
public:
     ...
     *
     * Ludirium only uses this "compact" format for encoding difficulty
...
#endif // LUDIRIUM_ARITH_UINT256_H
