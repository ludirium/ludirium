 ...
 */
#ifndef LUDIRIUM_UTIL_SYSTEM_H
#define LUDIRIUM_UTIL_SYSTEM_H
...
extern const char * const LUDIRIUM_CONF_FILENAME;
extern const char * const LUDIRIUM_SETTINGS_FILENAME;
