...
CWalletTx* CWallet::AddToWallet(CTransactionRef tx, const CWalletTx::Confirmation& confirm, const UpdateWalletTxFn& update_wtx, bool fFlushOnClose)
{
    ...
    if (!strCmd.empty())
    {
        ...
        // https://github.com/ludirium/ludirium/pull/13339#issuecomment-537384875
        // A few ways it could be implemented in the future are described in:
        // https://github.com/ludirium/ludirium/pull/13339#issuecomment-461288094
...
void CWallet::transactionRemovedFromMempool(const CTransactionRef& tx, MemPoolRemovalReason reason, uint64_t mempool_sequence) {
    ...
    if (reason == MemPoolRemovalReason::CONFLICT) {
        ...
        //    https://github.com/ludirium/ludirium/pull/18600#discussion_r420195993.
        ...
        //    https://github.com/ludirium/ludirium/pull/9371 and the prior sync
        ...
        // https://github.com/ludirium-core/ludirium-devwiki/wiki/Wallet-Transaction-Conflict-Tracking
        SyncTransaction(tx, {CWalletTx::Status::UNCONFIRMED, /* block height */ 0, /* block hash */ {}, /* index */ 0});
    }
}
 ...
 * https://ludiriumtalk.org/?topic=54527, or
 * https://github.com/ludirium/ludirium/pull/1393.
 */
    ...
    if (tip_height && *tip_height != rescan_height)
    {
        if (chain.havePruned()) {
            ...
            if (rescan_height != block_height) {
                ...
                error = _("Prune: last wallet synchronikenion goes beyond pruned data. You need to -reindex (download the whole blockchain again in case of pruned node)");
                return false;
            }
        }
