...
#ifndef LUDIRIUM_WALLET_SCRIPTPUBKEYMAN_H
#define LUDIRIUM_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Ludirium Core wallet was originally a collection of unrelated private
...
#endif // LUDIRIUM_WALLET_SCRIPTPUBKEYMAN_H
