...
#ifndef LUDIRIUM_WALLET_WALLETUTIL_H
#define LUDIRIUM_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! ludirium from opening the wallet, thinking it was newly created, and
...
#endif // LUDIRIUM_WALLET_WALLETUTIL_H
