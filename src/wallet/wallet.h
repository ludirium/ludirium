...
#ifndef LUDIRIUM_WALLET_WALLET_H
#define LUDIRIUM_WALLET_WALLET_H
...
//! Discourage users to set fees higher than this amount (in kenshins) per kB
constexpr CAmount HIGH_TX_FEE_PER_KB{COIN / 100};
//! -maxtxfee will warn if called with a higher fee than this amount (in kenshins)
...
public:
    ...
    /** Absolute maximum transaction fee (in kenshins) used by default for the wallet */
...
#endif // LUDIRIUM_WALLET_WALLET_H
