...
#ifndef LUDIRIUM_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define LUDIRIUM_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // LUDIRIUM_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
