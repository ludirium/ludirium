...
#ifndef LUDIRIUM_WALLET_ISMINE_H
#define LUDIRIUM_WALLET_ISMINE_H
 ...
 * https://github.com/ludirium/ludirium/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
...
#endif // LUDIRIUM_WALLET_ISMINE_H
