    ...
    platformStyle(_platformStyle)
{
    ...
    // normal ludirium address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying ludirium address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &LudiriumAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
