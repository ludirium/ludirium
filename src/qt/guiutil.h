...
#ifndef LUDIRIUM_QT_GUIUTIL_H
#define LUDIRIUM_QT_GUIUTIL_H
...
/** Utility functions used by the Ludirium Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "ludirium:" URI into recipient object, return true on successful parsing
