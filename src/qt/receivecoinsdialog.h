...
#ifndef LUDIRIUM_QT_RECEIVECOINSDIALOG_H
#define LUDIRIUM_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of ludiriums */
...
#endif // LUDIRIUM_QT_RECEIVECOINSDIALOG_H
