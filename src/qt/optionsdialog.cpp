    ...
    mapper(nullptr)
{
    ...
    ui->ludiriumAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->ludiriumAtStartup);
    ...
    ui->ludiriumAtStartup->setToolTip(ui->ludiriumAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->ludiriumAtStartup->setText(ui->ludiriumAtStartup->text().arg(PACKAGE_NAME));

    ui->openLudiriumConfButton->setToolTip(ui->openLudiriumConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new LudiriumUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->ludiriumAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openLudiriumConfButton_clicked()
{
