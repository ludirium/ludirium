...
#include <qt/ludiriumamountfield.h>
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<LudiriumAmountField*>("payAmount")->setValue(amount);
...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_ludirium-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_ludirium-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_ludirium-qt  # macOS
void TestGUI(interfaces::Node& node)
{
...

    {
        ...
        QString balanceComparison = LudiriumUnits::formatWithUnit(unit, balance, false, LudiriumUnits::SeparatorStyle::ALWAYS);
    ...
    // Amount input
    LudiriumAmountField* amountInput = receiveCoinsDialog.findChild<LudiriumAmountField*>("reqAmount");
...
void WalletTests::walletTests()
{
    ...
    if (QApplication::platformName() == "minimal") {
        ...
        QWARN("Skipping WalletTests on mac build with 'minimal' platform set due to Qt bugs. To run AppTests, invoke "
              "with 'QT_QPA_PLATFORM=cocoa test_ludirium-qt' on mac, or else use a linux or windows build.");
        return;
    }
#endif
    TestGUI(m_node);
