...
//! Entry point for LudiriumApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &LudiriumApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for LudiriumGUI tests.
void AppTests::guiTests(LudiriumGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &LudiriumGUI::consoleShown, this, &AppTests::consoleTests);
