...
#ifndef LUDIRIUM_INTERFACES_NODE_H
#define LUDIRIUM_INTERFACES_NODE_H
...
//! Top-level interface for a ludirium node (ludiriumd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // LUDIRIUM_INTERFACES_NODE_H
