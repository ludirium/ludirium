...
#ifndef LUDIRIUM_INTERFACES_INIT_H
#define LUDIRIUM_INTERFACES_INIT_H
...
//! (ludirium-gui, ludirium-node, ludirium-wallet, ludiriumd, ludirium-qt) and each
...
#endif // LUDIRIUM_INTERFACES_INIT_H
