...
#ifndef LUDIRIUM_CRYPTO_CHACHA_POLY_AEAD_H
#define LUDIRIUM_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@ludirium.
 *
 ...
 *
 * The chacha20-poly1305@ludirium combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@ludirium cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@ludirium are relatively fast in
...
#endif // LUDIRIUM_CRYPTO_CHACHA_POLY_AEAD_H
