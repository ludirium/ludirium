...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef LUDIRIUM_CHAINPARAMSSEEDS_H\n')
    g.write('#define LUDIRIUM_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the ludirium network\n')
    ...
    g.write('#endif // LUDIRIUM_CHAINPARAMSSEEDS_H\n')
