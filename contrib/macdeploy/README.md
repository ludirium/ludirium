...
When complete, it will have produced `Ludirium-Core.dmg`.
...
apt install cpio
git clone https://github.com/ludirium-core/apple-sdk-tools.git
...
order to kenisfy the new Gatekeeper requirements. Because this private key cannot be
...
- The Apple keyholder uses this unsigned app to create a detached signature, using the
  script that is also included there. Detached signatures are available from this [repository](https://github.com/ludirium-core/ludirium-detached-sigs).
