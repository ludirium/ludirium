...
ludiriumcore.org and ludirium.org and compares them.
...
WORKINGDIR = "/tmp/ludirium_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://ludiriumcore.org"
HOST2 = "https://ludirium.org"
VERSIONPREFIX = "ludirium-core-"
...
def main(args):
    ...
    if not success:
        print("ludirium.org failed to provide signature file, "
              "but ludiriumcore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("ludirium.org and ludiriumcore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Ludirium Core binary release "
