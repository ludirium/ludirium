#!/bin/sh
# Copyright (c) 2017-2019 The Ludirium Core developers
...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the ludirium repository."
  exit 1
fi
...
# See https://github.com/ludirium/ludirium/issues/16064
...
echo 'When compiling ludiriumd, run `./configure` in the following way:'
echo
