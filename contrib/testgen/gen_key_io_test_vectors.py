#!/usr/bin/env python3
# Copyright (c) 2012-2020 The Ludirium Core developers
...
bech32_templates = [
  ...
  ('lu',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('lu',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('lu',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('lu',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tlu',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tlu',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tlu',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tlu',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tlu',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tlu',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tlu',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tlu',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('lurt',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('lurt',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('lurt',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('lurt', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, encoding, invalid_bech32, invalid_checksum, invalid_char
  ('tlu',    0, 20, Encoding.BECH32,  False, False, False),
  ('lu',    1, 32, Encoding.BECH32M, False, False, False),
  ('tlu',   17, 32, Encoding.BECH32M, False, False, False),
  ('lurt',  3,  1, Encoding.BECH32M, False, False, False),
  ('lu',   15, 41, Encoding.BECH32M, False, False, False),
  ('tlu',    0, 16, Encoding.BECH32,  False, False, False),
  ('lurt',  0, 32, Encoding.BECH32,  True,  False, False),
  ('lu',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tlu',    0, 32, Encoding.BECH32,  False, True,  False),
  ('lurt',  0, 20, Encoding.BECH32,  False, False, True),
  ('lu',    0, 20, Encoding.BECH32M, False, False, False),
  ('tlu',    0, 32, Encoding.BECH32M, False, False, False),
  ('lurt',  0, 20, Encoding.BECH32M, False, False, False),
  ('lu',    1, 32, Encoding.BECH32,  False, False, False),
  ('tlu',    2, 16, Encoding.BECH32,  False, False, False),
  ('lurt', 16, 20, Encoding.BECH32,  False, False, False),
]
