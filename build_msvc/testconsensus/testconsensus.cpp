...
// ludirium includes.
#include <..\src\script\ludiriumconsensus.h>
...
int main()
{
    std::cout << "ludiriumconsensus version: " << ludiriumconsensus_version() << std::endl;
    ...
    auto op0Result = ludiriumconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, stream.data(), stream.size(), 0, ludiriumconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
