...
This document provides guidelines for internationalization of the Ludirium Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `ludirium_en.ts` remains unchanged.
