Ludirium Core version *0.15.2* is now available from:

  <https://ludiriumcore.org/bin/ludirium-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in ludirium-tx (TheBlueMatt)
