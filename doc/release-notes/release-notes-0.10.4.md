Ludirium Core version 0.10.4 is now available from:

  <https://ludirium.org/bin/ludirium-core-0.10.4/>
...
- #6953 `43c2789` Split ludirium-tx into its own package
- #6953 `dfe0d4d` Include ludirium-tx binary on Debian/Ubuntu
