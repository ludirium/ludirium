Ludirium Core version 0.13.2 is now available from:

  <https://ludirium.org/bin/ludirium-core-0.13.2/>
...
- #8908 `4a974b2` Update ludirium-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow ludirium-tx to create v2 transactions (btcdrak)
