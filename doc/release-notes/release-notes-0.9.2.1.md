Ludirium Core version 0.9.2.1 is now available from:

  https://ludirium.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 LUDi to 0.01 LUDi
...
- Fix "Start ludirium on system login"
