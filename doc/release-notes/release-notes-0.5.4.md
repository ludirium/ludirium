Ludirium version 0.5.4 is now available for download at:
http://sourceforge.net/projects/ludirium/files/Ludirium/ludirium-0.5.4/
...
http://gitorious.org/ludirium/ludiriumd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Ludirium-Qt notifications under Growl 1.3.
Increase required age of Ludirium-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxLudirium properly when installing Ludirium-Qt over it. (Windows)
