...
Ludirium Core version 0.19.1 is now available from:

  <https://ludiriumcore.org/bin/ludirium-core-0.19.1/>
...
From Ludirium Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Ludirium Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Ludirium Core does not yet change appearance when
...
- #17488 fix "ludiriumd already running" warnings on macOS (fanquake)
