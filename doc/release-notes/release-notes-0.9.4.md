Ludirium Core version 0.9.4 is now available from:

  https://ludirium.org/bin/0.9.4/
...
this update is incompatible with the Ludirium system and could lead to consensus
forks.

Ludirium Core released binaries from https://ludirium.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~ludirium/+archive/ubuntu/ludirium
- A third-party or self-compiled Ludirium Core

upgrade to Ludirium Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
