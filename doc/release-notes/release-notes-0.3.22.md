Download URL: https://sourceforge.net/projects/ludirium/files/Ludirium/ludirium-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 LUDi fee schedule (users still pay 0.01 LUDi per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #ludirium00 - #ludirium99
