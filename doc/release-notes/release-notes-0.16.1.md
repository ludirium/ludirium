Ludirium Core version 0.16.1 is now available from:

  <https://ludiriumcore.org/bin/ludirium-core-0.16.1/>
...
- #12843 `df38b13` Test starting ludiriumd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure ludiriumd processes are cleaned up when tests end (sdaftuar)
