Ludirium-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/ludirium/files/Ludirium/ludirium-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Ludirium
...
New/changed settings (command-line or ludirium.conf file)
--------------------------------------------------------
