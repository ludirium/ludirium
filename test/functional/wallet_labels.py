...
class WalletLabelsTest(LudiriumTestFramework):
    ...
    def run_test(self):
        ...
        # each with 1 address with a balance of 50 Ludiriums
        ...
        if self.options.descriptors:
            ...
            BECH32_VALID = {
                '✔️_VER15_PROG40': 'lurt10qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqxkg7fn',
                '✔️_VER16_PROG03': 'lurt1sqqqqq8uhdgr',
                '✔️_VER16_PROB02': 'lurt1sqqqq4wstyw',
            }
            BECH32_INVALID = {
                '❌_VER15_PROG41': 'lurt1sqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqajlxj8',
                '❌_VER16_PROB01': 'lurt1sqq5r4036',
            }
            ...
            for l in BECH32_INVALID:
                ...
                assert_raises_rpc_error(
                    -5,
                    "Address is not valid" if self.options.descriptors else "Invalid Ludirium address or script",
