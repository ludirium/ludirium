...
class KeyPoolTest(LudiriumTestFramework):
    ...
    def run_test(self):
        ...
        # Using a fee rate (10 ken / byte) well above the minimum relay rate
        # creating a 5,000 ken transaction with change should not be possible
        ...
        # creating a 10,000 ken transaction without change, with a manual input, should still be possible
        ...
        # creating a 10,000 ken transaction without change should still be possible
        ...
        # creating a 10,000 ken transaction with a manual change address should be possible
