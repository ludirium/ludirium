#!/usr/bin/env python3
# Copyright (c) 2018-2019 The Ludirium Core developers
...
class DeriveaddressesTest(LudiriumTestFramework):
    ...
    def run_test(self):
        ...
        address = "lurt1qjqmxmkpmxt80xz4y3746zgt0q3u3ferr34acd5"
        ...
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, [1, 2]), ["lurt1qhku5rq7jz8ulufe2y6fkcpnlvpsta7rq4442dy", "bcrt1qpgptk2gvshyl0s9lqshsmx932l9ccsv265tvaq"])
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, 2), [address, "lurt1qhku5rq7jz8ulufe2y6fkcpnlvpsta7rq4442dy", "bcrt1qpgptk2gvshyl0s9lqshsmx932l9ccsv265tvaq"])
