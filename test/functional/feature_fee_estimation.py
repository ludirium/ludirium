...
# Associated ScriptSig's to spend kenisfy P2SH_1 and P2SH_2
...
def small_txpuzzle_randfee(from_node, conflist, unconflist, amount, min_fee, fee_increment):
    ...
    fee = min_fee - fee_increment + kenshin_round(rand_fee)
    tx = CTransaction()
    ...
    # the ScriptSig that will kenisfy the ScriptPubKey.
    for inp in tx.vin:
...
def split_inputs(from_node, txins, txouts, initial_split=False):
    ...
    half_change = kenshin_round(prevtxout["amount"] / 2)
...
class EstimateFeeTest(LudiriumTestFramework):
