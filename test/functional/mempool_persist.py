...
By default, ludiriumd will dump mempool on shutdown and
...
class MempoolPersistTest(LudiriumTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent ludiriumd from writing mempool.dat to disk. Verify that `savemempool` fails")
