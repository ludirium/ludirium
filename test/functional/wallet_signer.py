#!/usr/bin/env python3
# Copyright (c) 2017-2018 The Ludirium Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test external signer.

Verify that a ludiriumd node can use an external signer command
...
class WalletSignerTest(LudiriumTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(address1, "lurt1qm90ugl4d48jv8n6e5t9ln6t9zlpm5th68x4f8g")
