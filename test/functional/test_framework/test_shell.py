...
class TestShell:
    """Wrapper Class for LudiriumTestFramework.

    The TestShell class extends the LudiriumTestFramework
    ...
    class __TestShell(LudiriumTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by LudiriumTestFramework child class.
            self.num_nodes = 1
