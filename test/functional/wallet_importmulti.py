...
class ImportMultiTest(LudiriumTestFramework):
    ...
    def run_test(self):
        ...
        # Ludirium Address (implicit non-internal)
        ...
        self.test_importmulti(
            {
                "scriptPubKey": {"address": "lurt1p0xlxvlhemja6c4dqv22uapctqupfhlxm9h8z3k2e72q4k9hcz7vqc8gma6"},
                "timestamp": "now",
            },
            success=False,
            error_code=-5,
