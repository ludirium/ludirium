...
class SegWitTest(LudiriumTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older ludiriumd's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let ludiriumd fill it in.
    ...
    def test_superfluous_witness(self):
        ...
        self.nodes[0].generate(1)
        unspent = next(u for u in self.nodes[0].listunspent() if u['spendable'] and u['address'].startswith('lurt'))
