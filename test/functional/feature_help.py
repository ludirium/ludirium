...
"""Verify that starting ludirium with -h works as expected."""

from test_framework.test_framework import LudiriumTestFramework
from test_framework.util import assert_equal

class HelpTest(LudiriumTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ludirium with -h for help text")
        ...
        self.log.info("Start ludirium with -version for version information")
        ...
        self.log.info("Start ludiriumd with -fakearg to make sure it does not start")
