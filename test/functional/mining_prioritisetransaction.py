#!/usr/bin/env python3
# Copyright (c) 2015-2019 The Ludirium Core developers
...
class PrioritiseTransactionTest(LudiriumTestFramework):
    ...
    def run_test(self):
        ...
        # Add a prioritikenion before a tx is in the mempool (de-prioritising a
