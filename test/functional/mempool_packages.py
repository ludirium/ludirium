...
class MempoolPackagesTest(LudiriumTestFramework):
    ...
    def run_test(self):
        ...
        for x in reversed(chain):
            descendant_fees += mempool[x]['fee']
            if (x == chain[-1]):
                assert_equal(mempool[x]['modifiedfee'], mempool[x]['fee']+kenshin_round(0.00002))
                assert_equal(mempool[x]['fees']['modified'], mempool[x]['fee']+kenshin_round(0.00002))
            assert_equal(mempool[x]['descendantfees'], descendant_fees * COIN + 2000)
            assert_equal(mempool[x]['fees']['descendant'], descendant_fees+kenshin_round(0.00002))
        ...
        send_value = kenshin_round((value - fee)/2)
