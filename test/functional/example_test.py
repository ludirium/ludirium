...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the LudiriumTestFramework
    pass


class ExampleTest(LudiriumTestFramework):
    # Each functional test is a subclass of the LudiriumTestFramework class.
    ...
    def custom_method(self):
        ...
        LudiriumTestFramework class so other tests can use it."""
