...
class P2PPermissionsTests(LudiriumTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].ludiriumconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].ludiriumconf, 'w', encoding="utf8") as f:
            f.write(newText)
